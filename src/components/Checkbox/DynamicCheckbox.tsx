...
import {Image, TextStyle, TouchableOpacityProps} from 'react-native';
...
const Checkbox = styled.View<{checked?: boolean}>`
  ...
  height: 24px;
  border-width: 1px;
  border-color: ${p => (p.checked ? Colors.backgroundHeader : Colors.grey5)};
  background-color: ${p =>
    p.checked ? Colors.backgroundHeader : Colors.grey6};
  border-radius: 6px;
  align-items: center;
